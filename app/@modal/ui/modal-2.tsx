  ...
  return (
    <Dialog open className="relative z-50" onClose={handleClose}>
      ...
      <div className="fixed inset-0 p-4 md:p-8 flex justify-center items-center">
        <DialogPanel className="relative pb-16 flex flex-col justify-between max-w-screen-lg h-[80dvh] mx-auto">
          <div className="pb-2 flex items-center grow justify-center flex-initial max-h-full">
            {children}
          </div>
